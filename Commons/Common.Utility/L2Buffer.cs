...
//TODO: Хорошо бы избавиться от этого класса. Они используется только в двух классах и наверняка всё это можно переработать
/// <summary>
...
{
    /// <summary>
    /// Copies array of values from source to destination buffer.
    /// </summary>
    ...
    /// <summary>
    /// Copies array of values to destination buffer.
    /// </summary>
    /// <param name="w">Reference to values array.</param>
    ...
    /// <summary>
    /// Returns new array of values, copied from the beginning of provided <paramref name="src" />
    /// pointer.
    /// </summary>
    /// <param name="src">Source values array pointer.</param>
    /// <param name="length">Length of array to copy.</param>
    /// <returns>
    /// New array of values, copied from the beginning of provided <paramref name="src" />
    /// pointer.
    /// </returns>
    public static unsafe short[] SpecialCopy(short* src, int length)
    {
        var destiny = new short[length];
    ...
    /// <summary>
    /// Gives string representation of values buffer.
    /// </summary>
    /// <param name="buffer">values array.</param>
    /// <returns>String representation of values array.</returns>
    public static string ToString(byte[] buffer)
    {
        var sb = new StringBuilder();
        sb.AppendFormat(
            "Buffer dump, length: {0}{1}Index   |---------------------------------------------|  |--------------|{1}",
            buffer.Length, Environment.NewLine);
    ...
    /// <summary>
    /// Converts values from one array to values array.
    /// </summary>
    /// <param name="src">values array reference.</param>
    /// <param name="srcOffset">values array offset.</param>
    /// <param name="dst">Destination string.</param>
    /// <param name="bytesCount">Amount of values to convert to <see cref="char" /> values.</param>
    ...
    /// <summary>
    /// Converts values array to values array.
    /// </summary>
    /// <param name="src">Source values buffer.</param>
    /// <param name="srcOffset">Source buffer offset.</param>
